"use strict";require("core-js/modules/es.array.iterator");var _process=_interopRequireDefault(require("process"));

var _moize=_interopRequireDefault(require("moize"));

var _main=require("./options/main.js");
var _warnings=require("./warnings.js");
var _limit=require("./limit.js");

var EVENTS=_interopRequireWildcard(require("./handle/main.js"));function _getRequireWildcardCache(){if(typeof WeakMap!=="function")return null;var cache=new WeakMap;_getRequireWildcardCache=function(){return cache};return cache}function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj}var cache=_getRequireWildcardCache();if(cache&&cache.has(obj)){return cache.get(obj)}var newObj={};if(obj!=null){var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc)}else{newObj[key]=obj[key]}}}}newObj.default=obj;if(cache){cache.set(obj,newObj)}return newObj}function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}


const logProcessErrors=function(opts){
const optsA=(0,_main.getOptions)({opts});
...
_process.default.removeListener(name,eventListener);
};
