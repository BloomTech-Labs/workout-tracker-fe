  ...
  switch (action.type) {
    ...
    case EVENTS.reset:
      ...
      [USER_ID, ANON_ID, USER_TRAITS].map(function (key) {
        analyticsUtils.storage.removeItem(key);
      });
      /* eslint-enable  */
...
function getPersistedUserData(params) {
  return {
    userId: analyticsUtils.storage.getItem(USER_ID) || params.an_uid,
    anonymousId: analyticsUtils.storage.getItem(ANON_ID) || params.an_aid || analyticsUtils.uuid(),
...
function analytics() {
  ...
  redux.combineReducers(objectSpread2({}, coreReducers, {}, customReducers)), // set user defined initial state
